...
export default function AliceHeader() {
  ...
  return (
    <header className="fixed md:static bg-bg-main top-0 z-100 md:rounded-xl left-0 right-0 p-3 flex flex-row items-center justify-between ring-1 ring-primary/25">
      <div>
