...
export default function NavBar({ toggleAddModal }: NavBarProp) {
  ...
  return (
    <nav className="flex w-full fixed z-30 left-0 bottom-0 ring-1 ring-primary/25 pt-3 pb-3 md:static md:max-w-20  md:h-full bg-bg-main md:ring-0 md:rounded-xl md:pt-5">
